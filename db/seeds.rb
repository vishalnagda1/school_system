...
Subject.create(:name=>'English', :school_id=>'1')
Subject.create(:name=>'Hindi', :school_id=>'1')
Subject.create(:name=>'Math', :school_id=>'1')
Subject.create(:name=>'Science', :school_id=>'2')
Subject.create(:name=>'Sanskrit', :school_id=>'2')

Teacher.create(:name=>'Vishal', :gender=>'male', :phone=>'7737986479', :subject_ids=>[1,2,3], :school_id=>1)
Teacher.create(:name=>'Chetan', :gender=>'male', :phone=>'8769032876', :subject_ids=>[2,1], :school_id=>1)
Teacher.create(:name=>'Aaryan', :gender=>'male', :phone=>'1234567890', :subject_ids=>[4,5], :school_id=>2)
Teacher.create(:name=>'Ajay', :gender=>'male', :phone=>'0987654321', :subject_ids=>[5], :school_id=>2)
